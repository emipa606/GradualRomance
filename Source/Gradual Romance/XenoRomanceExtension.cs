...
public class XenoRomanceExtension : DefModExtension
{
    ...
    public readonly List<Vector2> maturityByAgeCurveFemale = [];
    public readonly List<Vector2> maturityByAgeCurveMale = [];
    public readonly string mindCategory = "Humanoid";
    public readonly List<Vector2> sexDriveByAgeCurveFemale = [];

    public readonly List<Vector2> sexDriveByAgeCurveMale = [];
