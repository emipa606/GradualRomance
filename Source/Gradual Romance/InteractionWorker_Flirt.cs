    ...
    */
        ...
        out string letterText, out string letterLabel, out LetterDef letterDef, out LookTargets lookTargets)
    {
        ...
        */
        ...
        LogFlirt(
            $"{initiator.Name.ToStringShort}=>{recipient.Name.ToStringShort} attraction: physical {recipientPhysicalAttraction}, romantic {recipientRomanticAttraction}, social {recipientSocialAttraction}.");
        ...
        LogFlirt(
            $"{recipient.Name.ToStringShort}=>{initiator.Name.ToStringShort} attraction: physical {initiatorPhysicalAttraction}, romantic {initiatorRomanticAttraction}, social {initiatorSocialAttraction}.");
        ...
        else
        {
            ...
            LogFlirt(
                $"{recipient.Name.ToStringShort} chose reaction {flirtReaction.defName} from Successful: {successfulFlirt.defName}; Unsuccessful: {unsuccessfulFlirt.defName}.");
        }
    ...
    {
        var flirtLog = $"{pawn.Name.ToStringShort} => {other.Name.ToStringShort} considers {flirtStyle.defName}: ";
        ...
        Pawn initiator, Pawn recipient)
    {
        ...
        switch (successImpossible)
        {
            case true when flirtReaction.successful:
    ...
    private static float RelationshipFactorForFlirtStyle(PawnRelationDef relation, FlirtStyleDef flirtStyle)
    {
        ...
        return relation == PawnRelationDefOfGR.Sweetheart ? flirtStyle.sweetheartFactor : flirtStyle.acquaitanceFactor;
    }
