    ...
    public static class AttractionUtility
    {
            ...
            out AttractionFactorDef reasonForInstantFailure)
        {
            ...
            foreach (var factor in allFactors)
            {
                ...
                if (GradualRomanceMod.detailedAttractionLogs)
                {
                    Log.Message(factor.defName + "(" + observer.Name.ToStringShort + "," + assessed.Name.ToStringShort +
                                ")(" + category.defName + "): " + result + "=>" + (attraction * result));
                }
        ...
        public static bool QuickCheck(Pawn observer, Pawn assessed)
        {
            ...
            if (GradualRomanceMod.extraspeciesRomance ==
                GradualRomanceMod.ExtraspeciesRomanceSetting.OnlyXenophiles && !ModHooks.IsXenophile(observer))
            {
                return false;
            }
